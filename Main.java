...
public class Main {
    public static void main(String[] args) {
        ...
        laptops.add(new Laptop("Asus", 16, 1000, "Windows 10", "Желтый"));
        laptops.add(new Laptop("Lenovo", 12, 2000, "Windows 10", "Графитовый"));
        laptops.add(new Laptop("Apple", 16, 512, "macOS", "Серебристый"));
        laptops.add(new Laptop("Dell", 16, 500, "Windows 10", "Черный"));
    ...
    public static void filterLaptops(Set<Laptop> laptops) {
        ...
        if (criteria.containsKey(userInput)){
            ...
            if (filteredLaptops.isEmpty()){
                System.out.println("Ноутбуки, удовлетворяющие условиям филитрации, не найдены.");
            } else {
